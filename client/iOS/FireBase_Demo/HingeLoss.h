...
@interface HingeLoss : NSObject

//This method is used for SVM Hinge Loss
- (float *) computeGradSVM :(const float *)trainingFeature :(const float *)trainingLabel :(const float *)w :(long) D :(double) regConstant :(int) class;
